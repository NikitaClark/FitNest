...
public class GainMuscle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gainmuscle);
        ...
        progressBar.setMax(5); // Set the max value for the progress bar
    ...
    void updateQuestions(int questionNumber) {
        switch (questionNumber) {
            case 1:
                ...
                findViewById(R.id.buttonToneUp).setVisibility(View.VISIBLE);
                findViewById(R.id.buttonBulkUp).setVisibility(View.VISIBLE);
                findViewById(R.id.buttonGetStrong).setVisibility(View.VISIBLE);
            ...
            case 2:
                ...
                findViewById(R.id.buttonToneUp).setVisibility(View.GONE);
                findViewById(R.id.buttonBulkUp).setVisibility(View.GONE);
                findViewById(R.id.buttonGetStrong).setVisibility(View.GONE);
